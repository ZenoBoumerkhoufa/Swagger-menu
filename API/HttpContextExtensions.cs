...
namespace API
{
    public static class HttpContextExtensions
    {
        public static string ResolveClientIpAddress(this HttpContext context)
        {
            ...
            IHttpConnectionFeature? connection = context.Features.Get<IHttpConnectionFeature>(); if (connection == null || connection.RemoteIpAddress == null)
            {
        ...
        public static string ResolveServerIpAddress(this HttpContext context)
        {
            ...
            IHttpConnectionFeature? connection = context.Features.Get<IHttpConnectionFeature>(); if (connection == null || connection.LocalIpAddress == null)
            {
                throw new ArgumentNullException("IHttpConnectionFeature is null");
            }
